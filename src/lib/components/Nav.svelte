...
>
  <nav class="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3 sm:px-6">
    <a
      href="/"
      class="mr-auto flex items-center gap-2 tracking-tight"
    ...
    <div class="relative" data-lang-dropdown>
      ...
      {#if langOpen}
        ...
        >
          {#each LOCALES as l (l)}
            <button
              class="flex w-full items-center gap-2.5 rounded-lg px-3 py-2 text-left text-sm transition-colors hover:bg-muted {$locale ===
              l

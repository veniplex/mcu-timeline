...
<a
  ...
  class="items-center gap-2 rounded-full border border-border bg-surface px-3 py-1.5 text-sm font-medium transition-colors hover:bg-muted {className}"
...
>
  ...
  {#if starsLabel}
    ...
    >
      <Star class="size-3.5 fill-[#e0a82e] text-[#e0a82e]" aria-hidden="true" />
